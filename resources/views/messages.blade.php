                ...
                <div class="message-content-inner">
                    ...
                    <div class="message-bubble me">
                        <div class="message-bubble-inner">
                            <div class="message-avatar"><img src="{{ asset('assets/front/images/user-avatar-small-01.jpg') }}" alt="" />
                            </div>
                    ...
                    <div class="message-bubble">
                        <div class="message-bubble-inner">
                            <div class="message-avatar"><img src="{{ asset('assets/front/images/user-avatar-small-02.jpg') }}" alt="" />
                            </div>
                            <div class="message-text">
                    ...
                    <div class="message-bubble">
                        <div class="message-bubble-inner">
                            <div class="message-avatar"><img
                                    src="{{ asset('assets/front/images/user-avatar-small-02.jpg') }}" alt="" />
                            </div>
                            <div class="message-text">
                                <!-- Typing Indicator -->
